...
private:
	VulkanVideoSession(DeviceContext&	   devCtx,
					   VkVideoCoreProfile* pVideoProfile)
		: m_refCount(0), m_profile(*pVideoProfile), m_devCtx(devCtx), m_createInfo{VK_STRUCTURE_TYPE_VIDEO_SESSION_CREATE_INFO_KHR, NULL}, m_videoSession(VkVideoSessionKHR(0))
	{
