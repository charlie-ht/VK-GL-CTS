#ifndef _VULKANBISTREAMBUFFERIMPL_HPP
#define _VULKANBISTREAMBUFFERIMPL_HPP
/*------------------------------------------------------------------------
...
public:
    ...
    static VkResult Create(DeviceContext* devctx, uint32_t queueFamilyIndex,
...
private:
    ...
    static VkResult CreateBuffer(DeviceContext* ctx, uint32_t queueFamilyIndex,
    ...
    VulkanBitstreamBufferImpl(DeviceContext* devctx,
